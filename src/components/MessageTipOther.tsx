...
const MessageOther: React.FC<MessageOtherProps> = ({ message, senderName, profileImageUrl, timestamp }) => {
  return (
    <div className="h-[71px] pl-[10px] pb-2.5 flex items-start gap-1">
    ...
    <div className="flex pl-[10px]">
      <div className="relative bg-[#f2f2f7] text-black rounded-tr-lg rounded-br-lg rounded-bl-md px-3 py-2">
